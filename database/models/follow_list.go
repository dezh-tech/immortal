...
func (q followListQuery) One(ctx context.Context, exec boil.ContextExecutor) (*FollowList, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "database: failed to execute a one query for follow_list")
	}
...
func (q followListQuery) All(ctx context.Context, exec boil.ContextExecutor) (FollowListSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "database: failed to assign all query results to FollowList slice")
	}
...
func (q followListQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to count follow_list rows")
	}
...
func (q followListQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "database: failed to check if follow_list exists")
	}
...
func FindFollowList(ctx context.Context, exec boil.ContextExecutor, follower string, following string, selectCols ...string) (*FollowList, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "database: unable to select from follow_list")
	}
...
func (o *FollowList) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("database: no follow_list provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to insert into follow_list")
	}
...
func (o *FollowList) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("database: unable to update follow_list, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update follow_list row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by update for follow_list")
	}
...
func (q followListQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update all for follow_list")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to retrieve rows affected for follow_list")
	}
...
func (o FollowListSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update all in followList slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to retrieve rows affected all in update all followList")
	}
	return rowsAff, nil
}
...
func (o *FollowList) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("database: no follow_list provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("database: unable to upsert follow_list, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(followListPrimaryKeyColumns) == 0 {
				return errors.New("database: unable to upsert follow_list, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to upsert follow_list")
	}
...
func (o *FollowList) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("database: no FollowList provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete from follow_list")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by delete for follow_list")
	}
...
func (q followListQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("database: no followListQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete all from follow_list")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by deleteall for follow_list")
	}
...
func (o FollowListSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete all from followList slice")
	}
...
func (o *FollowList) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("database: no FollowList provided for reload")
	}
...
func (o *FollowListSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("database: empty FollowListSlice provided for reload all")
	}
...
func (o *FollowListSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to reload all in FollowListSlice")
	}
...
func FollowListExists(ctx context.Context, exec boil.ContextExecutor, follower string, following string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "database: unable to check if follow_list exists")
	}
