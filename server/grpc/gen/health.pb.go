...
type Service struct {
	...
	Status  Status `protobuf:"varint,2,opt,name=status,proto3,enum=immortal.Status" json:"status,omitempty"`
...
var file_health_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x6d, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x22, 0x61, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76,
	...
	0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x69, 0x6d, 0x6d, 0x6f, 0x72, 0x74,
	...
	0x32, 0x11, 0x2e, 0x69, 0x6d, 0x6d, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x2e, 0x53, 0x65, 0x72, 0x76,
	...
	,
...
var file_health_proto_goTypes = []interface{}{
	(Status)(0),            // 0: immortal.Status
	(*Service)(nil),        // 1: immortal.Service
	(*StatusRequest)(nil),  // 2: immortal.StatusRequest
	(*StatusResponse)(nil), // 3: immortal.StatusResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: immortal.Service.status:type_name -> immortal.Status
	1, // 1: immortal.StatusResponse.services:type_name -> immortal.Service
	2, // 2: immortal.HealthService.Status:input_type -> immortal.StatusRequest
	3, // 3: immortal.HealthService.Status:output_type -> immortal.StatusResponse
