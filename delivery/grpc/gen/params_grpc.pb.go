...
const (
	Parameters_UpdateParameters_FullMethodName = "/relay.v1.Parameters/UpdateParameters"
)
...
func (c *parametersClient) UpdateParameters(ctx context.Context, in *UpdateParametersRequest, opts ...grpc.CallOption) (*UpdateParametersResponse, error) {
	out := new(UpdateParametersResponse)
	err := c.cc.Invoke(ctx, Parameters_UpdateParameters_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedParametersServer) UpdateParameters(context.Context, *UpdateParametersRequest) (*UpdateParametersResponse, error) {
...
func _Parameters_UpdateParameters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParametersServer).UpdateParameters(ctx, req.(*UpdateParametersRequest))
	}
...
var Parameters_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "relay.v1.Parameters",
