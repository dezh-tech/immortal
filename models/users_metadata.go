...
func (q usersMetadatumQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsersMetadatum, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for users_metadata")
	}
...
func (q usersMetadatumQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsersMetadatumSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to UsersMetadatum slice")
	}
...
func (q usersMetadatumQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count users_metadata rows")
	}
...
func (q usersMetadatumQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if users_metadata exists")
	}
...
func FindUsersMetadatum(ctx context.Context, exec boil.ContextExecutor, pubKey string, selectCols ...string) (*UsersMetadatum, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from users_metadata")
	}
...
func (o *UsersMetadatum) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no users_metadata provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into users_metadata")
	}
...
func (o *UsersMetadatum) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update users_metadata, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update users_metadata row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for users_metadata")
	}
...
func (q usersMetadatumQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for users_metadata")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for users_metadata")
	}
...
func (o UsersMetadatumSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in usersMetadatum slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all usersMetadatum")
	}
	return rowsAff, nil
}
...
func (o *UsersMetadatum) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("models: no users_metadata provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert users_metadata, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(usersMetadatumPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert users_metadata, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert users_metadata")
	}
...
func (o *UsersMetadatum) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UsersMetadatum provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from users_metadata")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for users_metadata")
	}
...
func (q usersMetadatumQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no usersMetadatumQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from users_metadata")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for users_metadata")
	}
...
func (o UsersMetadatumSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usersMetadatum slice")
	}
...
func (o *UsersMetadatum) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no UsersMetadatum provided for reload")
	}
...
func (o *UsersMetadatumSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty UsersMetadatumSlice provided for reload all")
	}
...
func (o *UsersMetadatumSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in UsersMetadatumSlice")
	}
...
func UsersMetadatumExists(ctx context.Context, exec boil.ContextExecutor, pubKey string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if users_metadata exists")
	}
