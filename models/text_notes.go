...
func (q textNoteQuery) One(ctx context.Context, exec boil.ContextExecutor) (*TextNote, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for text_notes")
	}
...
func (q textNoteQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count text_notes rows")
	}
...
func (q textNoteQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if text_notes exists")
	}
...
func FindTextNote(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*TextNote, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from text_notes")
	}
...
func (o *TextNote) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no text_notes provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into text_notes")
	}
...
func (o *TextNote) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update text_notes, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update text_notes row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for text_notes")
	}
...
func (q textNoteQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for text_notes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for text_notes")
	}
...
func (o *TextNote) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("models: no text_notes provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert text_notes, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(textNotePrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert text_notes, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert text_notes")
	}
...
func (o *TextNote) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from text_notes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for text_notes")
	}
...
func (q textNoteQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from text_notes")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for text_notes")
	}
...
func (o *TextNote) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no TextNote provided for reload")
	}
...
func (o *TextNoteSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty TextNoteSlice provided for reload all")
	}
...
func TextNoteExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if text_notes exists")
	}
